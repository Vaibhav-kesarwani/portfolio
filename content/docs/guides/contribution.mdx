...
```tsx title="example-component-demo.tsx"
...
````md title="example-component.mdx"
---
title: CircularText
...
For any help or questions, please open a new [GitHub issue](https://github.com/Vaibhav-kesarwani/portfolio/issues/new).